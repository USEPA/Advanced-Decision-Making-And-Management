...
urlpatterns = [
    ...
    re_path(r'^api/team/(?P<team_id>\d+)/$', APITeamDetailView.as_view(),
    ...
    re_path(r'^list/$', TeamListView.as_view(), name='team_list'),
    re_path(r'^team/(?P<team_id>\d+)/manage$', TeamManagementView.as_view(),
        name='team_manage'),
    re_path(r'^team/(?P<team_id>\d+)/edit$', TeamEditView.as_view(),
        name='team_edit'),
]
